...
<div class="py-16 flex-1 flex flex-col items-stretch justify-start gap-1">
    ...
    <div class="text-box mb-2">
        ...
        <br>
        I'm currently employed as a Gameplay Programmer at <a href="https://italicpig.com/" target="_blank" rel="noopener noreferrer" class="link">Italic Pig</a>, working on our upcoming title <a href="https://store.steampowered.com/app/1202200/Paleo_Pines/" class="link" target="_blank" rel="noopener noreferrer">Paleo Pines</a>. My main responsibility is implementing gameplay systems, but I also often get involved in tasks outside programming. You can read more about my experience <a href="/paleo" class="link">here</a>.
        <br><br>
        <div class="image-group">
        ...
        <br>
        <b>Engines:</b> Unity, Godot, Unreal Engine<br>
