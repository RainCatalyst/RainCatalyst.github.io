...
var app = (function () {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$5, 21, 16, 789);
    			attr_dev(div, "class", "w-8 h-8");
    			add_location(div, file$5, 20, 12, 750);
    			attr_dev(h4, "class", "font-bold text-lg ml-2");
    			add_location(h4, file$5, 27, 12, 1067);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$5, 16, 16, 597);
    			attr_dev(span0, "class", "animated-underline-low");
    			add_location(span0, file$5, 17, 16, 654);
    			attr_dev(span1, "class", "btn group ml-2");
    			add_location(span1, file$5, 15, 12, 550);
    		},
    		m: function mount(target, anchor) {
    ...
    // (24:12) {#each project.images as src}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$4, 25, 20, 981);
    			attr_dev(div, "class", "card");
    			add_location(div, file$4, 24, 16, 941);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(24:12) {#each project.images as src}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$4, 12, 8, 389);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 9, 4, 324);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 23, 2, 622);
    			attr_dev(div1, "class", "flex flex-col");
    			add_location(div1, file, 21, 1, 578);
    			attr_dev(main, "class", "text-primary");
    			add_location(main, file, 20, 0, 548);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
