    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$6, 7, 4, 184);
    			attr_dev(a, "href", /*href*/ ctx[1]);
    			attr_dev(a, "class", "contact-link");
    			add_location(a, file$6, 8, 4, 222);
    			attr_dev(div, "class", "black-outline p-4 flex flex-row items-center justify-center gap-2 basis-1/5");
    ...
    function create_description_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br = element("br");
    			t1 = text("1 year");
    			add_location(br, file$5, 21, 52, 1373);
    			attr_dev(span, "slot", "description");
    			add_location(span, file$5, 21, 12, 1333);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_description_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(span, "slot", "description");
    			add_location(span, file$5, 29, 16, 1778);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$5, 13, 12, 936);
    			attr_dev(div1, "class", "basis-2/5 aspect-square");
    			add_location(div1, file$5, 12, 8, 885);
