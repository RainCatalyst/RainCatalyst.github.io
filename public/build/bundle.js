...
var app = (function () {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(source, file$7, 5, 8, 137);
    			video.autoplay = true;
    			video.loop = true;
    			video.muted = true;
    			attr_dev(video, "id", "reel");
    			attr_dev(video, "class", "background");
    			add_location(video, file$7, 4, 4, 71);
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t2 = text(/*text*/ ctx[0]);
    			add_location(div0, file$6, 20, 12, 546);
    			attr_dev(div1, "class", "link");
    			add_location(div1, file$6, 23, 12, 604);
    			attr_dev(div2, "class", "flex flex-row items-start justify-start font-code font-light gap-3");
    			add_location(div2, file$6, 19, 8, 452);
    			attr_dev(a, "href", /*href*/ ctx[1]);
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "rel", "noopener noreferrer");
    			add_location(a, file$6, 18, 4, 390);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t2 = text(/*text*/ ctx[0]);
    			add_location(div0, file$6, 9, 12, 229);
    			attr_dev(div1, "class", "link");
    			add_location(div1, file$6, 12, 12, 287);
    			attr_dev(div2, "class", "flex flex-row items-start justify-start font-code font-light gap-3");
    			add_location(div2, file$6, 8, 8, 135);
    			attr_dev(a, "href", /*href*/ ctx[1]);
    			add_location(a, file$6, 7, 4, 115);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, div2);
    ...
    class NavItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { text: 0, href: 1, local: 2 });
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$5, 10, 4, 244);
    			attr_dev(div2, "class", "font-light mt-3");
    			add_location(div2, file$5, 13, 4, 362);
    			attr_dev(div3, "class", "item-group");
    			add_location(div3, file$5, 16, 4, 438);
    			attr_dev(div4, "class", "font-light mt-3");
    			add_location(div4, file$5, 21, 4, 657);
    			attr_dev(div5, "class", "item-group");
    			add_location(div5, file$5, 24, 4, 724);
    			attr_dev(div6, "class", "content-side");
    			add_location(div6, file$5, 6, 0, 133);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$4, 5, 4, 143);
    ...
    function create_fragment$3(ctx) {
    	...
    	navitem0 = new NavItem({
    			props: { text: "itch", href: "/vfx" },
    			$$inline: true
    		});

    	navitem1 = new NavItem({
    			props: { text: "github", href: "/vfx" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img_1, "alt", "");
    			add_location(img_1, file$3, 13, 8, 297);
    			attr_dev(div0, "class", "card basis-1/2");
    			add_location(div0, file$3, 12, 4, 259);
    			attr_dev(div1, "class", "font-code text-2xl mt-3 basis-1/8");
    			add_location(div1, file$3, 15, 4, 372);
    			attr_dev(div2, "class", "font-code text-xl mt-3 basis-1/6");
    			add_location(div2, file$3, 18, 4, 453);
    			attr_dev(div3, "class", "flex flex-col basis-1/4 h-1/2 p-4");
    			add_location(div3, file$3, 10, 0, 178);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    			...
    			if (description_slot) {
    				if (description_slot.p && (!current || dirty & /*$$scope*/ 16)) {
    					update_slot_base(
    						...
    						: get_slot_changes(description_slot_template, /*$$scope*/ ctx[4], dirty, get_description_slot_changes),
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('ProjectCard', slots, ['description']);
    	let { name } = $$props;
    	let { img } = $$props;
    	let { href } = $$props;
    	...
    	$$self.$capture_state = () => ({ name, img, href, description, NavItem });
    	...
    	return [name, img, href, description, $$scope, slots];
    }

    class ProjectCard extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { name: 0, img: 1, href: 2, description: 3 });
    ...
    function create_description_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 9, 12, 325);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(8:4) {#each {length: 6} as _, i}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "content-full flex flex-row flex-wrap");
    			add_location(div, file$2, 6, 0, 141);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ ProjectCard, cards, metas });
    	return [];
    }
    ...
    function create_default_slot_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 18, 12, 511);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 23, 12, 639);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file, 24, 12, 692);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "background bg-black");
    			add_location(div0, file, 29, 12, 822);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file, 30, 12, 875);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div0, anchor);
    			insert_dev(target, t, anchor);
    			insert_dev(target, div1, anchor);
    			mount_component(games, div1, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(empty_1.$$.fragment);
    			attr_dev(div0, "class", "background bg-black");
    			add_location(div0, file, 35, 12, 1003);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file, 36, 12, 1056);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div0, anchor);
    			insert_dev(target, t, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 14, 0, 428);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
