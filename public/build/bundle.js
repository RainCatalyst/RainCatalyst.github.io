...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div4, file$5, 21, 4, 648);
    			attr_dev(div5, "class", "item-group");
    			add_location(div5, file$5, 24, 4, 715);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img_1, "alt", "");
    			add_location(img_1, file$3, 12, 4, 267);
    			attr_dev(div0, "class", "h-1/2 w-full flex flex-row bg-gray-100");
    			add_location(div0, file$3, 13, 4, 317);
    			attr_dev(div1, "class", "project-card");
    			add_location(div1, file$3, 10, 0, 178);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class ProjectCard extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { name: 1, img: 0, href: 2, description: 3 });
    ...
    function create_description_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 9, 12, 306);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "project-container");
