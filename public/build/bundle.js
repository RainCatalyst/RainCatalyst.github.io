...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "background bg-black");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t2 = text(/*text*/ ctx[0]);
    			add_location(div0, file$4, 8, 8, 175);
    			attr_dev(div1, "class", "link");
    			add_location(div1, file$4, 11, 8, 221);
    			attr_dev(div2, "class", "flex flex-row items-start justify-start font-code font-light gap-3");
    			add_location(div2, file$4, 7, 4, 85);
    			attr_dev(a, "href", /*href*/ ctx[1]);
    			add_location(a, file$4, 6, 0, 69);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class NavItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { text: 0, href: 1 });
    ...
    function create_fragment$3(ctx) {
    	...
    	navitem0 = new NavItem({
    			props: { text: "work", href: "/work" },
    			$$inline: true
    		});

    	navitem1 = new NavItem({
    			props: { text: "games", href: "/games" },
    			$$inline: true
    		});

    	navitem2 = new NavItem({
    			props: { text: "vfx", href: "/vfx" },
    			$$inline: true
    		});

    	navitem3 = new NavItem({
    			props: { text: "linkedin", href: "/test" },
    			$$inline: true
    		});

    	navitem4 = new NavItem({
    			props: { text: "github", href: "/test" },
    			$$inline: true
    		});

    	navitem5 = new NavItem({
    			props: { text: "twitter", href: "/test" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$3, 10, 4, 244);
    			attr_dev(div2, "class", "font-light mt-3");
    			add_location(div2, file$3, 13, 4, 362);
    			attr_dev(div3, "class", "item-group");
    			add_location(div3, file$3, 16, 4, 438);
    			attr_dev(div4, "class", "font-light mt-3");
    			add_location(div4, file$3, 21, 4, 615);
    			attr_dev(div5, "class", "item-group");
    			add_location(div5, file$3, 24, 4, 682);
    			attr_dev(div6, "class", "content-side");
    			add_location(div6, file$3, 6, 0, 133);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 17, 12, 464);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 22, 12, 592);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file, 24, 12, 650);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(empty_1.$$.fragment);
    			attr_dev(div, "class", "content");
    			add_location(div, file, 29, 12, 780);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
