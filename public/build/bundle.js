...
var app = (function () {
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$7, 11, 8, 264);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$7, 9, 8, 203);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { text: 0, href: 1, pressed: 2 });
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$6, 16, 16, 597);
    			attr_dev(span0, "class", "animated-underline-low");
    			add_location(span0, file$6, 17, 16, 654);
    			attr_dev(span1, "class", "btn group ml-2");
    			add_location(span1, file$6, 15, 12, 550);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$5 = "src\\components\\Selector.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$5, 11, 4, 323);
    			attr_dev(nav, "class", "flex justify-center mb-2 gap-4");
    			add_location(nav, file$5, 9, 0, 204);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (42:12) {#each project.images as src}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$4, 43, 20, 1561);
    			attr_dev(div, "class", "card");
    			add_location(div, file$4, 42, 16, 1521);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(42:12) {#each project.images as src}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$4, 18, 8, 541);
    			...
    			video.muted = true;
    			video.loop = true;
    			add_location(video, file$4, 20, 12, 660);
    			attr_dev(div0, "class", "card self-stretch aspect-video");
    			add_location(div0, file$4, 19, 8, 602);
    			attr_dev(div1, "class", "mx-3");
    			add_location(div1, file$4, 23, 12, 822);
    			attr_dev(div2, "class", "text-block self-stretch");
    			add_location(div2, file$4, 22, 8, 771);
    			attr_dev(div3, "class", "flex flex-row gap-4 self-stretch items-stretch");
    			add_location(div3, file$4, 40, 8, 1400);
    			attr_dev(div4, "class", "flex flex-col justify-start items-center gap-5 w-full lg:w-1/2");
    			add_location(div4, file$4, 17, 4, 455);
    			attr_dev(div5, "class", "flex justify-center");
    			add_location(div5, file$4, 16, 0, 382);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*project*/ 1 && raw_value !== (raw_value = /*project*/ ctx[0].description + "")) div1.innerHTML = raw_value;
    			if (dirty & /*project*/ 1) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 16, 4, 558);
    			attr_dev(div1, "class", "flex flex-col items-center");
    			add_location(div1, file$1, 13, 0, 337);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ ProjectCard, fly, cards, onMount });
    	return [];
    }
