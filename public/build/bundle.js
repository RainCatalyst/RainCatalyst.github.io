...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			span1 = element("span");
    			add_location(span0, file$6, 6, 4, 122);
    			attr_dev(span1, "class", "animated-underline");
    			add_location(span1, file$6, 7, 4, 147);
    			attr_dev(a, "class", "btn group");
    			attr_dev(a, "href", /*href*/ ctx[1]);
    			add_location(a, file$6, 5, 0, 74);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	return [text, href, click_handler];
    }

    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { text: 0, href: 1 });
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			h4 = element("h4");
    			h4.textContent = "FreezedIce";
    			attr_dev(img, "class", "h-full");
    			if (!src_url_equal(img.src, img_src_value = "img/logo.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$5, 20, 16, 729);
    			attr_dev(div, "class", "w-8 h-8");
    			add_location(div, file$5, 19, 12, 690);
    			attr_dev(h4, "class", "font-bold text-lg ml-2");
    			add_location(h4, file$5, 26, 12, 1007);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span0 = element("span");
    			attr_dev(img, "class", "h-full");
    			if (!src_url_equal(img.src, img_src_value = "img/logo_forward.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$5, 12, 16, 402);
    			attr_dev(div, "class", "w-8 h-8 grow-0");
    			add_location(div, file$5, 11, 12, 356);
    			attr_dev(h4, "class", "font-bold text-lg");
    			add_location(h4, file$5, 15, 16, 537);
    			attr_dev(span0, "class", "animated-underline-low");
    			add_location(span0, file$5, 16, 16, 594);
    			attr_dev(span1, "class", "btn group ml-2");
    			add_location(span1, file$5, 14, 12, 490);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "flex justify-start items-center self-stretch cursor-pointer");
    			add_location(div0, file$5, 9, 4, 219);
    			attr_dev(div1, "class", "flex justify-end items-center gap-4");
    			add_location(div1, file$5, 29, 4, 1090);
    			attr_dev(nav, "class", "sidebar flex flex-row justify-between items-center");
    			add_location(nav, file$5, 8, 0, 149);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ back, Button, replace });
    	...
    	return [back, click_handler];
    }

    class Navbar extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { back: 0 });
    ...
    var projects = [
    	{
    		card: {
    			...
    			description: "A minimalist puzzle game about connecting stars",
    			image: "img/constellations/logo.png",
    			hoverImage: "img/constellations/gameplay.mp4"
    		},
    		description: {
    			title: "Constellations",
    			description: "Constellations is a minimalist puzzle game about connecting stars. <br>The game is released on Steam and itch.io and is coming to mobile devices soon.",
    			contribution: "...",
    ...
    // (16:8) {#each project.images as src}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$4, 17, 16, 632);
    			attr_dev(div, "class", "card");
    			add_location(div, file$4, 16, 12, 596);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*project*/ 1 && !src_url_equal(img.src, img_src_value = /*src*/ ctx[2])) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(16:8) {#each project.images as src}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	let div3;
    	let div2;
    	let raw0_value = /*project*/ ctx[0].description + "";
    	let t4;
    	let h41;
    	let t6;
    	let div5;
    	let div4;
    	let raw1_value = /*project*/ ctx[0].contribution + "";
    	let div7_intro;
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			h41 = element("h4");
    			h41.textContent = "Involvement";
    			t6 = space();
    			div5 = element("div");
    			div4 = element("div");
    			if (!src_url_equal(video.src, video_src_value = /*project*/ ctx[0].video)) attr_dev(video, "src", video_src_value);
    			attr_dev(video, "class", "h-full object-contain");
    			video.autoplay = true;
    			video.muted = true;
    			video.loop = true;
    			add_location(video, file$4, 13, 12, 442);
    			attr_dev(div0, "class", "card");
    			add_location(div0, file$4, 12, 8, 410);
    			attr_dev(div1, "class", "flex flex-col gap-4 items-stretch grow-0 basis-1/4");
    			add_location(div1, file$4, 11, 4, 336);
    			attr_dev(h40, "class", "font-bold text-2xl");
    			add_location(h40, file$4, 22, 8, 827);
    			attr_dev(div2, "class", "mr-4 ml-1");
    			add_location(div2, file$4, 24, 12, 926);
    			attr_dev(div3, "class", "text-block");
    			add_location(div3, file$4, 23, 8, 888);
    			attr_dev(h41, "class", "font-bold text-2xl");
    			add_location(h41, file$4, 28, 8, 1040);
    			attr_dev(div4, "class", "mr-4 ml-1");
    			add_location(div4, file$4, 30, 12, 1135);
    			attr_dev(div5, "class", "text-block");
    			add_location(div5, file$4, 29, 8, 1097);
    			attr_dev(div6, "class", "flex flex-col justify-start items-start gap-5 basis-3/4 md:basis-3/5");
    			add_location(div6, file$4, 21, 4, 735);
    			attr_dev(div7, "class", "flex flex-row justify-start items-start gap-5 w-full");
    			add_location(div7, file$4, 10, 0, 230);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*project*/ 1 && !src_url_equal(video.src, video_src_value = /*project*/ ctx[0].video)) {
    			...
    			if (dirty & /*project*/ 1 && t2_value !== (t2_value = /*project*/ ctx[0].title + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*project*/ 1 && raw0_value !== (raw0_value = /*project*/ ctx[0].description + "")) div2.innerHTML = raw0_value;			if (dirty & /*project*/ 1 && raw1_value !== (raw1_value = /*project*/ ctx[0].contribution + "")) div4.innerHTML = raw1_value;		},
    		i: function intro(local) {
    			if (!div7_intro) {
    				add_render_callback(() => {
    					div7_intro = create_in_transition(div7, fly, { y: 15, duration: 250 });
    					div7_intro.start();
    				});
    			}
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['project', 'params'];
    	...
    	$$self.$capture_state = () => ({ project, params, fly, descriptions });
    ...
    class ProjectDescription extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { project: 0, params: 1 });
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$2, 23, 8, 787);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			video.muted = true;
    			video.loop = true;
    			add_location(video, file$2, 21, 8, 670);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*hovered*/ ctx[4]) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$2, 26, 8, 896);
    			attr_dev(span1, "class", "block text-secondary text-sm");
    			add_location(span1, file$2, 27, 8, 944);
    			attr_dev(div0, "class", "m-4");
    			add_location(div0, file$2, 25, 4, 869);
    			attr_dev(div1, "class", "card-animated");
    			add_location(div1, file$2, 18, 0, 458);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div1, "click", /*select*/ ctx[7], false, false, false),
    					listen_dev(div1, "mouseenter", /*onHover*/ ctx[5], false, false, false),
    					listen_dev(div1, "mouseleave", /*onDehover*/ ctx[6], false, false, false)
    				];
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['title', 'description', 'image', 'hoverImage', 'index'];
    ...
    // (11:8) {#each cards as card, i}
    function create_each_block(ctx) {
    	let projectcard;
    	let current;
    	const projectcard_spread_levels = [/*card*/ ctx[0], { index: /*i*/ ctx[2] }];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const projectcard_changes = (dirty & /*cards*/ 0)
    			? get_spread_update(projectcard_spread_levels, [get_spread_object(/*card*/ ctx[0]), projectcard_spread_levels[1]])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(11:8) {#each cards as card, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h4, "class", "font-bold text-2xl");
    			add_location(h4, file$1, 8, 4, 230);
    			attr_dev(div0, "class", "mt-5 grid gap-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-3");
    			add_location(div0, file$1, 9, 4, 280);
    			add_location(div1, file$1, 7, 0, 185);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ ProjectCard, fly, cards });
    	return [];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 23, 2, 642);
    			attr_dev(div1, "class", "flex flex-col");
    			add_location(div1, file, 21, 1, 574);
    			attr_dev(main, "class", "text-primary");
    			add_location(main, file, 20, 0, 544);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$location*/ 1) navbar_changes.back = /*$location*/ ctx[0] != '/';
