...
var app = (function () {
    ...
    /* src\components\Background.svelte generated by Svelte v3.50.1 */

    const file$d = "src\\components\\Background.svelte";
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(source.src, source_src_value = "video/reel.mp4")) attr_dev(source, "src", source_src_value);
    			attr_dev(source, "type", "video/mp4");
    			add_location(source, file$d, 5, 8, 137);
    			video.autoplay = true;
    			video.loop = true;
    			video.muted = true;
    			attr_dev(video, "id", "reel");
    			attr_dev(video, "class", "background");
    			add_location(video, file$d, 4, 4, 71);
    		},
    ...
    /* src\components\NavItem.svelte generated by Svelte v3.50.1 */

    const file$c = "src\\components\\NavItem.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t2 = text(/*text*/ ctx[0]);
    			add_location(div0, file$c, 20, 12, 546);
    			attr_dev(div1, "class", "link");
    			add_location(div1, file$c, 23, 12, 604);
    			attr_dev(div2, "class", "flex flex-row items-start justify-start font-code font-light gap-3");
    			add_location(div2, file$c, 19, 8, 452);
    			attr_dev(a, "href", /*href*/ ctx[1]);
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "rel", "noopener noreferrer");
    			add_location(a, file$c, 18, 4, 390);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t2 = text(/*text*/ ctx[0]);
    			add_location(div0, file$c, 9, 12, 229);
    			attr_dev(div1, "class", "link");
    			add_location(div1, file$c, 12, 12, 287);
    			attr_dev(div2, "class", "flex flex-row items-start justify-start font-code font-light gap-3");
    			add_location(div2, file$c, 8, 8, 135);
    			attr_dev(a, "href", /*href*/ ctx[1]);
    			add_location(a, file$c, 7, 4, 115);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, div2);
    ...
    function create_fragment$c(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*local*/ ctx[2]) return create_if_block;
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['text', 'href', 'local'];
    	...
    	$$self.$capture_state = () => ({ text, href, local });
    	...
    	return [text, href, local];
    }

    class NavItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$c, create_fragment$c, safe_not_equal, { text: 0, href: 1, local: 2 });
    		...
    		if (/*text*/ ctx[0] === undefined && !('text' in props)) {
    			console.warn("<NavItem> was created without expected prop 'text'");
    		}

    		if (/*href*/ ctx[1] === undefined && !('href' in props)) {
    			console.warn("<NavItem> was created without expected prop 'href'");
    		}
    	}
    ...
    function create_fragment$b(ctx) {
    	...
    	navitem2 = new NavItem({
    			props: { text: "vfx", href: "/vfx", local: "true" },
    			$$inline: true
    		});
    	...
    	navitem4 = new NavItem({
    			props: {
    				text: "github",
    				href: "https://github.com/RainCatalyst"
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			div6 = element("div");
    			div0 = element("div");
    			div0.textContent = "Hi, I'm FreezedIce.";
    			t1 = space();
    			div1 = element("div");
    			div1.textContent = "A gameplay programmer with a passion for game design and tech art.";
    			t3 = space();
    			div2 = element("div");
    			div2.textContent = "Here is what I do —";
    			t5 = space();
    			div3 = element("div");
    			...
    			attr_dev(div0, "class", "text-4xl font-bold");
    			add_location(div0, file$b, 7, 4, 165);
    			attr_dev(div1, "class", "font-light");
    			add_location(div1, file$b, 10, 4, 244);
    			attr_dev(div2, "class", "font-light mt-3");
    			add_location(div2, file$b, 13, 4, 362);
    			attr_dev(div3, "class", "item-group");
    			add_location(div3, file$b, 16, 4, 438);
    			attr_dev(div4, "class", "font-light mt-3");
    			add_location(div4, file$b, 21, 4, 648);
    			attr_dev(div5, "class", "item-group");
    			add_location(div5, file$b, 24, 4, 715);
    			attr_dev(div6, "class", "content-side");
    			add_location(div6, file$b, 6, 0, 133);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(navitem0, div3, null);
    			append_dev(div3, t6);
    			mount_component(navitem1, div3, null);
    			append_dev(div3, t7);
    			mount_component(navitem2, div3, null);
    			append_dev(div6, t8);
    			append_dev(div6, div4);
    			append_dev(div6, t10);
    			append_dev(div6, div5);
    			mount_component(navitem3, div5, null);
    			append_dev(div5, t11);
    			mount_component(navitem4, div5, null);
    			append_dev(div5, t12);
    			mount_component(navitem5, div5, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ NavItem, cards, metas });
    	return [];
    }
    ...
    const file$a = "src\\pages\\Empty.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "text-2xl font-code");
    			add_location(span, file$a, 5, 4, 143);
    			attr_dev(div, "class", "h-full w-full flex justify-center items-center");
    			add_location(div, file$a, 3, 0, 23);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\components\GameNavItem.svelte generated by Svelte v3.50.1 */

    const file$9 = "src\\components\\GameNavItem.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$9, 10, 12, 306);
    			attr_dev(div1, "class", "link");
    			add_location(div1, file$9, 13, 12, 364);
    			attr_dev(div2, "class", "flex flex-row items-start justify-start font-code font-light gap-3");
    			add_location(div2, file$9, 9, 8, 212);
    			attr_dev(a, "href", /*href*/ ctx[1]);
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "rel", "noopener noreferrer");
    			add_location(a, file$9, 8, 4, 150);
    			attr_dev(div3, "class", "font-code ml-6");
    			add_location(div3, file$9, 18, 4, 458);
    			attr_dev(div4, "class", "flex flex-col");
    			add_location(div4, file$9, 7, 0, 117);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('GameNavItem', slots, []);
    	let { name } = $$props;
    	let { img } = $$props;
    	let { href } = $$props;
    	let { description } = $$props;
    	const writable_props = ['name', 'img', 'href', 'description'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<GameNavItem> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ name, img, href, description });
    	...
    	return [name, href, description, img];
    }

    class GameNavItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$9, safe_not_equal, { name: 0, img: 3, href: 1, description: 2 });
    		...
    		if (/*name*/ ctx[0] === undefined && !('name' in props)) {
    			console.warn("<GameNavItem> was created without expected prop 'name'");
    		}

    		if (/*img*/ ctx[3] === undefined && !('img' in props)) {
    			console.warn("<GameNavItem> was created without expected prop 'img'");
    		}

    		if (/*href*/ ctx[1] === undefined && !('href' in props)) {
    			console.warn("<GameNavItem> was created without expected prop 'href'");
    		}

    		if (/*description*/ ctx[2] === undefined && !('description' in props)) {
    			console.warn("<GameNavItem> was created without expected prop 'description'");
    		}
    	}

    	get name() {
    		throw new Error("<GameNavItem>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set name(value) {
    		throw new Error("<GameNavItem>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src\components\ProjectItemCard.svelte generated by Svelte v3.50.1 */
    const file$8 = "src\\components\\ProjectItemCard.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			t1 = text(/*name*/ ctx[0]);
    			attr_dev(img_1, "class", "w-[250px] aspect-video card object-cover");
    			if (!src_url_equal(img_1.src, img_1_src_value = /*img*/ ctx[1])) attr_dev(img_1, "src", img_1_src_value);
    			attr_dev(img_1, "alt", "");
    			add_location(img_1, file$8, 12, 4, 259);
    			attr_dev(div0, "class", "font-code text-2xl mt-3");
    			add_location(div0, file$8, 13, 4, 336);
    			attr_dev(div1, "class", "project-card");
    			add_location(div1, file$8, 10, 0, 170);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('ProjectItemCard', slots, []);
    	let { name } = $$props;
    	let { img } = $$props;
    	let { href } = $$props;
    	let { description } = $$props;
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ProjectItemCard> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ name, img, href, description, NavItem: GameNavItem });
    	...
    	return [name, img, href, description];
    }

    class ProjectItemCard extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { name: 0, img: 1, href: 2, description: 3 });

    		dispatch_dev("SvelteRegisterComponent", {
    			component: this,
    			tagName: "ProjectItemCard",
    			options,
    			id: create_fragment$8.name
    		});
    		...
    		if (/*name*/ ctx[0] === undefined && !('name' in props)) {
    			console.warn("<ProjectItemCard> was created without expected prop 'name'");
    		}

    		if (/*img*/ ctx[1] === undefined && !('img' in props)) {
    			console.warn("<ProjectItemCard> was created without expected prop 'img'");
    		}

    		if (/*href*/ ctx[2] === undefined && !('href' in props)) {
    			console.warn("<ProjectItemCard> was created without expected prop 'href'");
    		}

    		if (/*description*/ ctx[3] === undefined && !('description' in props)) {
    			console.warn("<ProjectItemCard> was created without expected prop 'description'");
    		}
    	}

    	get name() {
    		throw new Error("<ProjectItemCard>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set name(value) {
    		throw new Error("<ProjectItemCard>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src\pages\Games.svelte generated by Svelte v3.50.1 */
    const file$7 = "src\\pages\\Games.svelte";
    ...
    function create_description_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$7, 11, 16, 425);
    		},
    		m: function mount(target, anchor) {
    ...
    // (10:8) {#each {length: 3} as _, i}
    function create_each_block_1$1(ctx) {
    	let projectitemcard;
    	let current;

    	projectitemcard = new ProjectItemCard({
    			props: {
    	...
    	const block = {
    		c: function create() {
    			create_component(projectitemcard.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(projectitemcard, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const projectitemcard_changes = {};

    			if (dirty & /*$$scope*/ 16) {
    				projectitemcard_changes.$$scope = { dirty, ctx };
    			}

    			projectitemcard.$set(projectitemcard_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(projectitemcard.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(projectitemcard.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(projectitemcard, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(10:8) {#each {length: 3} as _, i}",
    		ctx
    	});
    ...
    function create_description_slot(ctx) {
    	let span;
    	let t_value = cards[/*i*/ ctx[2] + 3].description + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(span, "slot", "description");
    			add_location(span, file$7, 21, 16, 784);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    ...
    function create_each_block$1(ctx) {
    	...
    	projectitemcard = new ProjectItemCard({
    			props: {
    				name: cards[/*i*/ ctx[2] + 3].title,
    				img: cards[/*i*/ ctx[2] + 3].image,
    				href: cards[/*i*/ ctx[2] + 3].link,
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(20:8) {#each {length: 3} as _, i}",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "project-column");
    			add_location(div0, file$7, 8, 4, 247);
    			attr_dev(div1, "class", "project-column");
    			add_location(div1, file$7, 15, 4, 546);
    			attr_dev(div2, "class", "project-column");
    			add_location(div2, file$7, 18, 4, 594);
    			attr_dev(div3, "class", "project-container");
    			add_location(div3, file$7, 7, 0, 210);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ ProjectItemCard, NavItem: GameNavItem, cards, metas });
    	return [];
    }
    ...
    /* src\components\ProjectCard.svelte generated by Svelte v3.50.1 */
    const file$6 = "src\\components\\ProjectCard.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			div0 = element("div");
    			attr_dev(img_1, "class", "project-image");
    			if (!src_url_equal(img_1.src, img_1_src_value = /*img*/ ctx[0])) attr_dev(img_1, "src", img_1_src_value);
    			attr_dev(img_1, "alt", "");
    			add_location(img_1, file$6, 12, 4, 259);
    			attr_dev(div0, "class", "flex-grow bg-gray-100");
    			add_location(div0, file$6, 13, 4, 309);
    			attr_dev(div1, "class", "project-card");
    			add_location(div1, file$6, 10, 0, 170);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	return [img, name, href, description];
    }

    class ProjectCard extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { name: 1, img: 0, href: 2, description: 3 });
    		...
    		if (/*img*/ ctx[0] === undefined && !('img' in props)) {
    			console.warn("<ProjectCard> was created without expected prop 'img'");
    		}

    		if (/*href*/ ctx[2] === undefined && !('href' in props)) {
    			console.warn("<ProjectCard> was created without expected prop 'href'");
    		}
    ...
    /* src\pages\GamesList.svelte generated by Svelte v3.50.1 */
    const file$5 = "src\\pages\\GamesList.svelte";
    ...
    // (15:12) {#each {length: 3} as _, i}
    function create_each_block_1(ctx) {
    	let gamenavitem;
    	let current;

    	gamenavitem = new GameNavItem({
    			props: {
    				name: cards[/*i*/ ctx[2]].title.toLowerCase(),
    				href: cards[/*i*/ ctx[2]].link,
    				description: cards[/*i*/ ctx[2]].description.toLowerCase(),
    				local: "true"
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			create_component(gamenavitem.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(gamenavitem, target, anchor);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(gamenavitem.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(gamenavitem.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(gamenavitem, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(15:12) {#each {length: 3} as _, i}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	gamenavitem = new GameNavItem({
    			props: {
    				name: cards[/*i*/ ctx[2] + 3].title.toLowerCase(),
    				href: cards[/*i*/ ctx[2] + 3].link,
    				description: cards[/*i*/ ctx[2] + 3].description.toLowerCase(),
    				local: "true"
    			},
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(20:12) {#each {length: 3} as _, i}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	navitem = new NavItem({
    			props: { text: "back", href: "/", local: "true" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			div4 = element("div");
    			div0 = element("div");
    			t0 = text("We make games with my friend during our free time. ");
    			br = element("br");
    			t1 = text("I was responsible for coding and co-designing those games —");
    			t2 = space();
    			div3 = element("div");
    			div1 = element("div");
    			...
    			add_location(br, file$5, 10, 59, 427);
    			attr_dev(div0, "class", "font-light");
    			add_location(div0, file$5, 9, 4, 342);
    			attr_dev(div1, "class", "item-group mt-2 pb-2");
    			add_location(div1, file$5, 13, 8, 562);
    			attr_dev(div2, "class", "item-group mt-2 pb-2");
    			add_location(div2, file$5, 18, 8, 839);
    			attr_dev(div3, "class", "w-full flex flex-row flex-wrap");
    			add_location(div3, file$5, 12, 4, 508);
    			attr_dev(div4, "class", "content-full flex flex-col items-start justify-center gap-1");
    			add_location(div4, file$5, 8, 0, 263);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div4, t4);
    			mount_component(navitem, div4, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*cards*/ 0) {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('GamesList', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<GamesList> was created with unknown prop '${key}'`);
    	});
    ...
    class GamesList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\components\TextItem.svelte generated by Svelte v3.50.1 */

    const file$4 = "src\\components\\TextItem.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			t4 = text(/*extra*/ ctx[1]);
    			add_location(div0, file$4, 7, 8, 191);
    			add_location(div1, file$4, 10, 8, 237);
    			attr_dev(div2, "class", "flex flex-row items-start justify-start font-code font-light gap-3");
    			add_location(div2, file$4, 6, 4, 101);
    			attr_dev(div3, "class", "font-code ml-6");
    			add_location(div3, file$4, 14, 4, 296);
    			attr_dev(div4, "class", "flex flex-col");
    			add_location(div4, file$4, 5, 0, 68);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*text*/ 1) set_data_dev(t2, /*text*/ ctx[0]);
    			if (dirty & /*extra*/ 2) set_data_dev(t4, /*extra*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('TextItem', slots, []);
    	let { text } = $$props;
    	let { extra } = $$props;
    	const writable_props = ['text', 'extra'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<TextItem> was created with unknown prop '${key}'`);
    	});
    ...
    class TextItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { text: 0, extra: 1 });
    		...
    		if (/*text*/ ctx[0] === undefined && !('text' in props)) {
    			console.warn("<TextItem> was created without expected prop 'text'");
    		}

    		if (/*extra*/ ctx[1] === undefined && !('extra' in props)) {
    			console.warn("<TextItem> was created without expected prop 'extra'");
    		}
    	}

    	get text() {
    		throw new Error("<TextItem>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set text(value) {
    		throw new Error("<TextItem>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_fragment$3(ctx) {
    	...
    	gamenavitem = new GameNavItem({
    			props: {
    				name: "company",
    				href: "https://italicpig.com/",
    				description: "italic pig",
    				local: "true"
    			},
    			$$inline: true
    		});

    	textitem0 = new TextItem({
    			props: {
    				text: "role",
    				extra: "gameplay programmer"
    			},
    			$$inline: true
    		});

    	textitem1 = new TextItem({
    			props: { text: "stack", extra: "c#, unity3d" },
    			$$inline: true
    		});

    	textitem2 = new TextItem({
    			props: { text: "span", extra: "1 year" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			create_component(textitem2.$$.fragment);
    			t5 = space();
    			create_component(navitem.$$.fragment);
    			attr_dev(div0, "class", "font-light");
    			add_location(div0, file$3, 9, 4, 336);
    			attr_dev(div1, "class", "item-group mt-2 pb-2");
    			add_location(div1, file$3, 12, 4, 396);
    			attr_dev(div2, "class", "content-full flex flex-col items-start justify-center gap-1");
    			add_location(div2, file$3, 8, 0, 257);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div2, t1);
    			append_dev(div2, div1);
    			mount_component(gamenavitem, div1, null);
    			append_dev(div1, t2);
    			mount_component(textitem0, div1, null);
    			append_dev(div1, t3);
    			mount_component(textitem1, div1, null);
    			append_dev(div1, t4);
    			mount_component(textitem2, div1, null);
    			append_dev(div2, t5);
    			mount_component(navitem, div2, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			...
    			transition_in(textitem2.$$.fragment, local);
    			transition_in(navitem.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			...
    			transition_out(textitem2.$$.fragment, local);
    			transition_out(navitem.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div2);
    			destroy_component(gamenavitem);
    			destroy_component(textitem0);
    			destroy_component(textitem1);
    			destroy_component(textitem2);
    			destroy_component(navitem);
    		}
    	};
    ...
    /* src\pages\Art.svelte generated by Svelte v3.50.1 */
    const file$2 = "src\\pages\\Art.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	navitem0 = new NavItem({
    			props: {
    				text: "artstation",
    				href: "https://www.artstation.com/raincatalyst"
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			div2 = element("div");
    			div0 = element("div");
    			div0.textContent = "Links to my vfx projects (both realtime and not) —";
    			t1 = space();
    			div1 = element("div");
    			create_component(navitem0.$$.fragment);
    			t2 = space();
    			create_component(navitem1.$$.fragment);
    			attr_dev(div0, "class", "font-light");
    			add_location(div0, file$2, 9, 4, 336);
    			attr_dev(div1, "class", "item-group mt-2 pb-2");
    			add_location(div1, file$2, 12, 4, 438);
    			attr_dev(div2, "class", "content-full flex flex-col items-start justify-center gap-1");
    			add_location(div2, file$2, 8, 0, 257);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div2, t1);
    			append_dev(div2, div1);
    			mount_component(navitem0, div1, null);
    			append_dev(div2, t2);
    			mount_component(navitem1, div2, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    ...
    function create_default_slot_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 31, 12, 926);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "background bg-black");
    			add_location(div0, file, 36, 12, 1054);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file, 37, 12, 1107);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_2(ctx) {
    	...
    	let gameslist;
    	let current;
    	gameslist = new GamesList({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			div1 = element("div");
    			create_component(gameslist.$$.fragment);
    			attr_dev(div0, "class", "background bg-black");
    			add_location(div0, file, 42, 12, 1236);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file, 43, 12, 1289);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div0, anchor);
    			insert_dev(target, t, anchor);
    			insert_dev(target, div1, anchor);
    			mount_component(gameslist, div1, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(gameslist.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(gameslist.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div0);
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "background bg-black");
    			add_location(div0, file, 48, 12, 1421);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file, 49, 12, 1474);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div0, anchor);
    			insert_dev(target, t, anchor);
    			insert_dev(target, div1, anchor);
    			mount_component(art, div1, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 27, 0, 843);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
